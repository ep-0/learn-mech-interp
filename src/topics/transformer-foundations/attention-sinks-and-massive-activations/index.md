...
- Xiao et al., *Efficient Streaming Language Models with Attention Sinks* (arXiv:2309.17453) — Start here. Where the term comes from, plus the evidence that the sink is functional rather than decorative.
